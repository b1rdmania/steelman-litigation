...
const WELLINGTON_DEMO = {
  ...
  brief: {
    ...
    summary: (
      'Wellington Holdings entered a £12M revolving credit facility with Sterling Bank in March 2024. By Q4 2024 they had breached the leverage covenant. Wellington claims Sterling waived the breach through informal correspondence — chiefly an email of 17 May 2025 and three subsequent meetings. Sterling called the loan in October 2025. Wellington seeks a declaration of variation or waiver; alternatively, damages.\n\n' +
      'The case turns on construction, not implication. The 17 May email is ambiguous on a fair reading and does not satisfy the facility\'s formal-amendment clause. No deed of variation was executed. The bank\'s relationship manager was authorised to discuss, not commit. Where Yam Seng is invoked, BNP Paribas v Trattamento sits on the same shelf and is the case the bench will reach for first. The procedural and substantive sub-agents independently flagged this as a case that loses on construction in the first hearing — before the merits are reached.'
    ),
    failure_scenarios: [
      {
        category: 'procedural',
...
const FOXBRIDGE_DEMO = {
  ...
  brief: {
    ...
    summary: (
      'The claimant is a former equity partner of Foxbridge Partners LLP, removed in late 2025 after what the firm calls a performance-management process. She has filed an Equality Act 2010 claim alleging direct discrimination and victimisation by the remuneration and management committees. The firm\'s ET3 turns on the argument that, as an equity partner, she is not a "worker" under s.230(3)(b) of the Employment Rights Act 1996.\n\n' +
      'That defence is foreclosed. Clyde & Co LLP v Bates van Winkelhof [2014] UKSC 32 settled the point in the Supreme Court. A partner in an LLP is a worker. The firm\'s lead defence loses at the first hearing before the merits are reached.\n\n' +
      'The rest is worse. Key decisions about the claimant were taken in a WhatsApp group that was subsequently deleted. The ET3 raises a scope objection that is procedurally late and unparticularised. The firm\'s three lead witnesses have given materially different accounts of the same meeting. A contested hearing risks a reported judgment in a Magic Circle adjacent market. The settlement window is open now; it closes the moment disclosure is ordered.'
    ),
    failure_scenarios: [
      {
        category: 'procedural',
